...
public class TimeUtil {
	...
	public static Date ceiling(Date date, int field){
		...
		c.setTime(date);
		switch (field) {
			case Calendar.YEAR: 	c.clear(Calendar.MONTH); //ATENTION! No break, this will cascade!
			case Calendar.MONTH:	c.clear(Calendar.DATE);
			case Calendar.DATE:		c.clear(Calendar.HOUR);
			case Calendar.HOUR:		c.clear(Calendar.MINUTE);
